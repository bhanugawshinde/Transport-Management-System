...
<section id="sideMenu" class="side-menu">
	...
	<button id=view-truck class="menu-itam" onclick="get('http://localhost:8080/TruckTransport/ViewTruck','page-content')">View Truck</button>
	<button id=add-truck class="menu-itam" onclick="get('FrontEnd/pages/Truck/AddTruck.jsp','page-content');" >Add Truck</button>
	<button id=update-truck class="menu-itam" onclick="get('http://localhost:8080/TruckTransport/ViewTruck?var=update','page-content')">Update Truck</button>
	<button id=delete-truck class="menu-itam" onclick="get('http://localhost:8080/TruckTransport/ViewTruck?var=delete','page-content')">Delete Truck</button>
</section>
<div id="main-content">
