...
<button class="delete" onclick="deleteRow('http://localhost:8080/TruckTransport/DeleteManager','http://localhost:8080/TruckTransport/ViewManager?var=delete')">Delete</button>
