...
<button class="delete" onclick="deleteRow('http://localhost:8080/TruckTransport/DeleteEmployee','http://localhost:8080/TruckTransport/ViewEmployee?var=delete')">Delete</button>
