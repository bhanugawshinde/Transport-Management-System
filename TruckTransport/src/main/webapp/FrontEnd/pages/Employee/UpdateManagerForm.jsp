...
<button class=button type="button" onclick="submit(event,'http://localhost:8080/TruckTransport/UpdateManager','updateManager','http://localhost:8080/TruckTransport/ViewManager');">
Update Manager
</button>
