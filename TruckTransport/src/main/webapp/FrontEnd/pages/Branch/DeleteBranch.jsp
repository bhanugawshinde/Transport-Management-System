...
<button class="delete" onclick="deleteRow('http://localhost:8080/TruckTransport/DeleteBranch','http://localhost:8080/TruckTransport/ViewBranch?var=delete')">Delete</button>
</body>
</html>
