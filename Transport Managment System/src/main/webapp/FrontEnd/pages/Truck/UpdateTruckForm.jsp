...
<button class=button type="button" onclick="submit(event,'http://localhost:8080/Transport-Managment-System/UpdateTruck','updateTruck','http://localhost:8080/Transport-Managment-System/ViewTruck?var=update');">
Update Truck
</button>
