...
<button class=button type="button" onclick="submit(event,'http://localhost:8080/TruckTransport/UpdateTruck','updateTruck','http://localhost:8080/TruckTransport/ViewTruck?var=update');">
Update Truck
</button>
