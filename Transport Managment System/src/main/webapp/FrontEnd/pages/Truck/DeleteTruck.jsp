...
<button class="delete" onclick="deleteRow('http://localhost:8080/TruckTransport/DeleteTruck','http://localhost:8080/TruckTransport/ViewTruck?var=delete')">Delete</button>
