...
<section id="sideMenu" class="side-menu">
	...
	<button id=view-truck class="menu-itam" onclick="get('ViewTruck','page-content')">View Truck</button>
	<button id=add-truck class="menu-itam" onclick="get('FrontEnd/pages/Truck/AddTruck.jsp','page-content');" >Add Truck</button>
	<button id=update-truck class="menu-itam" onclick="get('ViewTruck?var=update','page-content')">Update Truck</button>
	<button id=delete-truck class="menu-itam" onclick="get('ViewTruck?var=delete','page-content')">Delete Truck</button>
</section>
<div id="main-content">
	<div id=page-content>
		<div class="box">
				<div class="item" onclick="event.stopPropagation(); executeSequentially('Truck', 'main', 'ViewTruck', 'page-content')">
					<div class="box" >
						...
						<span class="bi bi-gear-wide-connected updateButton"
							onclick="event.stopPropagation(); executeSequentially('Truck', 'main', 'ViewTruck?var=update', 'page-content')"></span>
						
						<span class="bi bi-trash3 deleteButton"
							onclick="event.stopPropagation(); executeSequentially('Truck', 'main', 'ViewTruck?var=delete', 'page-content')"></span>
