...
<p id=resp></p>
<form method=post class="form" id=updateEmployee >
	<h3 class="formGroupHead">General Details:</h3>
<div class="form-group">
	<div>
	<label for="employeeId">Employee Id</label>
	<input type="text" id=employeeId name="employeeId" maxlength="50" value="<%=map.get("employeeId")%>" readonly="readonly">	
	</div>
	<div>
...
<div class="form-group">
	 <div >
        ...
        <select id="managerId" name="managerId">
        	<option selected="selected"><%=map.get("managerId")%></option>
        </select>
     </div>
	 <div >
...
<button class=button type="button" onclick="submit(event,'UpdateEmployee','updateEmployee','ViewEmployee');">
Update Employee
</button>
