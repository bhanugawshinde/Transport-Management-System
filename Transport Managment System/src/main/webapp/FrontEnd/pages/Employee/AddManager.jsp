...
<body >
<h2 class="formHead">Add Manager</h2>
<p id=resp></p>
<form method=post class="form" id=addmanager >
...
<button class=button type="button" onclick="submit(event,'http://localhost:8080/TruckTransport/AddManager','addmanager','http://localhost:8080/TruckTransport/ViewManager');">
Add Manager
</button>
