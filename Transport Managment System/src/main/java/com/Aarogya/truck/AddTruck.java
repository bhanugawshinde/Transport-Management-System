...
public class AddTruck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Map<String, String> map = mapObject.entrySet().stream()
		...
		float currentMileage = map.get("currentMileage") != null ? Integer.parseInt(map.get("currentMileage")) : 0;
		...
		TruckBean truckBean = new TruckBean(profile, licensePlate, companyName, model, yearOfManufacture,
