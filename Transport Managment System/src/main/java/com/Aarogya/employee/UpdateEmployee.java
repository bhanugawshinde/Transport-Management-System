...
public class UpdateEmployee extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		EmployeeBean emp = new EmployeeBean(employeeId, firstName, lastName, email, phoneNumber, dateOfBirth, hireDate, department, address, city, state, postalCode, country, null, managerId, branchId, salary);
		// Response
